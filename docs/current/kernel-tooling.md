...
Workflow selection now lives in bootstrap and workflow markdown. Deterministic scripts support audit, resume, workflow-state, and verification; they do not replace markdown as the control plane.
