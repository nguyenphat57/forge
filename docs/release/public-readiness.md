...
Date: 2026-04-13
Status: `2.4.0` is the current stable release after the operator-surface closure and public bootstrap retirement cut.
...
- release-facing docs now align on `2.4.0` as the stable source version

## Verdict

Forge `2.4.0` is in a reasonable state for public stable release under the current policy.
