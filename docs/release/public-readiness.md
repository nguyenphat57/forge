...
Date: 2026-04-22
Status: `2.14.3` is the current stable release after the skill-wording hardening pass and latest verification gate.
...
- release-facing docs now align on `2.14.3` as the stable source version

## Verdict

Forge `2.14.3` is in a reasonable state for public stable release under the current policy.
