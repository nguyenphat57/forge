...
Date: 2026-04-13
Status: `2.3.2` is the current stable release after the unified preferences release cut.
...
- release-facing docs now align on `2.3.2` as the stable source version

## Verdict

Forge `2.3.2` is in a reasonable state for public stable release under the current policy.
