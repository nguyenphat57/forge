...
- Forge `2.5.0` is the current stable release after the maintenance-only closure sync, historical-roadmap retirement sweep, and the latest canonical verification gate all passed.
