...
- Forge `5.0.0` is the current stable release after release bump, bootstrap, session, and delegation behavior moved to sibling skills and the retired `workflows/` compatibility surface was removed.
