...
- Forge `2.4.0` is the current stable release after the operator-surface closure cut, bootstrap retirement from the public repo surface, and the latest canonical verification gate all passed.
