...
- Forge `4.0.0` is the current stable release after `help`, `next`, and `run` were removed from the public operator surface, leaving guidance and command execution natural-language first.
