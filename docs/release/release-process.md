...
- Forge `1.15.0` is the current stable release after the host-aware delegation preference release cut and the latest canonical verification gate both passed.
