...
- Forge `2.14.0` is the current stable release after the markdown-first sibling skill split, Superpowers-style skill absorption, and latest verification gate passed.
