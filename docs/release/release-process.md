...
- Forge `2.8.0` is the current stable release after the installed-workflow shortcut materialization slice and the latest targeted verification gate passed.
