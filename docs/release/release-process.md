...
- Forge `3.3.0` is the current stable release after session continuity moved fully to `forge-session-management`, public session operator actions were removed, and the latest verification gate passed.
