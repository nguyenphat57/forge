...
- Forge `3.2.1` is the current stable release after the stable-line metadata refresh, delegation-setting cleanup, stronger subagent auto-activation gate, Visual Companion ownership move, and latest verification gate passed.
