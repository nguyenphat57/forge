...
- Forge `5.2.0` is the current stable release after generated host artifacts, install and render contracts, and owner-command guidance moved preference resolver references to sibling skill `forge-customize`.
