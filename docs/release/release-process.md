...
- Forge `3.2.2` is the current stable release after the Windows Forge Codex UTF-8 activation fix, the installed-bundle Vietnamese preference repro coverage, and the latest verification gate passed.
