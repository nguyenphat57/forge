...
- Forge `1.12.0` is the current stable release after the `1.12.0` cut sweep, the `1.12.x roadmap-complete` sweep, and the latest canonical verification gate all passed.
