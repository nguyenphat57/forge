...
- Forge `3.2.0` is the current stable release after the delegation-preference removal, stronger subagent auto-activation gate, Visual Companion ownership move, and latest verification gate passed.
