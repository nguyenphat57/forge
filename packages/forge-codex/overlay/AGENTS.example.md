...
Forge is the execution kernel and orchestration system for this workspace. Keep this entry thin and let the bundle own routing, verification, and packet semantics.

Use `forge-codex` as the global Forge entrypoint for this workspace.
