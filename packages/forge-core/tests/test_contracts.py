...
class BundleContractTests(unittest.TestCase):
    ...
    def test_split_skills_own_tdd_debug_review_and_completion_contracts(self) -> None:
        ...
        self.assertIn("delegation-first assessment", build)
        self.assertIn("When the Codex host supports subagents", build)
        self.assertIn("forge-subagent-driven-development", build)
