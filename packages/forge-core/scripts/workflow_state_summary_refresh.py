...
def build_packet_index(state: dict) -> dict:
    ...
    return {
        ...
        "ready_packets": string_list(latest_chain.get("ready_packets")),
        "running_packets": string_list(latest_chain.get("running_packets")),
        "completed_packets": string_list(latest_chain.get("completed_packets")),
        "blocked_packets": string_list(latest_chain.get("blocked_packets")),
        "current_wave_blocked_packets": string_list(latest_chain.get("current_wave_blocked_packets")),
        ...
        "wave_plan_id": latest_chain.get("wave_plan_id"),
        "wave_index": latest_chain.get("wave_index"),
        "wave_count": latest_chain.get("wave_count"),
        "next_ready_wave": string_list(latest_chain.get("next_ready_wave")),
        "shared_verification": string_list(latest_chain.get("shared_verification")),
        "shared_verification_status": latest_chain.get("shared_verification_status"),
        "shared_verification_pending": string_list(latest_chain.get("shared_verification_pending")),
