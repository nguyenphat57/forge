...
from common import configure_stdio, default_artifact_dir, detect_runtimes, load_registry, slugify, timestamp_slug
...
def build_report(workspace: Path, workspace_name: str | None = None) -> dict:
    ...
    scenario_reports = [
        evaluate_route_scenario(scenario, repo_signals, workspace_router)
