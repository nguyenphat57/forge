    ...
    if kind == "chain-status":
        ...
        return {
            **common_fields,
            ...
            "ready_packets": coalesce_list(report, "ready_packets"),
            "running_packets": coalesce_list(report, "running_packets"),
            "completed_packets": coalesce_list(report, "completed_packets"),
            "blocked_packets": coalesce_list(report, "blocked_packets"),
            "current_wave_blocked_packets": coalesce_list(report, "current_wave_blocked_packets"),
            ...
            "wave_plan_id": coalesce_string(report, "wave_plan_id"),
            "wave_index": report.get("wave_index"),
            "wave_count": report.get("wave_count"),
            "next_ready_wave": coalesce_list(report, "next_ready_wave"),
            ...
            "shared_verification": coalesce_list(report, "shared_verification"),
            "shared_verification_status": coalesce_string(report, "shared_verification_status") or "not-needed",
            "shared_verification_pending": coalesce_list(report, "shared_verification_pending"),
