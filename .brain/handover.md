HANDOVER
- Current task: Keep release and continuity surfaces aligned to the `2.7.0` stable line when future edits touch release-facing text or repo-state guidance.
- Done: The older `1.17.0` slim-refactor handoff is historical; the current stable line in repo-facing docs is `2.7.0`.
- Done: `VERSION`, `CHANGELOG.md`, `README.md`, `docs/release/public-readiness.md`, `docs/release/release-process.md`, and `.brain/decisions.json` agree on `2.7.0`.
...
- Verification run: `python scripts/verify_repo.py` -> PASS on 2026-04-17.
